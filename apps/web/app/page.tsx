...
export default async function Home() {
  ...
  return <main>
    <nav className="site-nav" aria-label="Primary navigation"><a className="brand" href="/"><span className="brand-mark">E</span> knowledge hub</a><div className="nav-links"><a href="#catalog">Catalog</a><a href="/publish">Publish</a><a href="/auth/sign-in">Sign in</a><a className="nav-button" href="/auth/sign-up">Create account</a></div></nav>
    ...
    <section className="publish" id="publish" aria-labelledby="publish-title"><p className="eyebrow">For publishers</p><h2 id="publish-title">Publish once. Let Siduri handle the rest.</h2><a className="button button-dark" href="/publish">Publish a pack <span aria-hidden="true">↗</span></a></section>
