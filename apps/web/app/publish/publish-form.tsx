...
export function PublishForm({ projectId }: { projectId?: string }) {
  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setStatus({ kind: "success", message: `${result.packageId} v${result.version} is ready in the catalog.` }); setFile(null); setProviderKey(null); setCopied(false); form.reset();
