...
export default function DocsPage() {
  return <main className="docs-page">
    ...
    <section className="docs-overview" aria-labelledby="docs-overview-title"><div className="docs-section-intro"><h2 id="docs-overview-title">Choose how knowledge travels.</h2><p>The content contract stays the same whether Siduri downloads a portable archive or retrieves from your hosted provider.</p></div><div className="docs-paths"><Link className="docs-path" href="/docs/remote-provider"><span className="docs-path-number">01</span><div><h3>Remote provider</h3><p>Keep your data where it is. Give the Hub a public provider URL and prove ownership once.</p><span className="docs-path-link">Read the provider guide ↗</span></div></Link><div className="docs-path"><span className="docs-path-number">02</span><div><h3>Local archive</h3><p>Package a validated E directory as a <code>.tar.gz</code> file. The Hub stores the immutable archive and its checksum.</p><span className="docs-path-link">Publish from the dashboard ↗</span></div></div></div></section>
