...
export default function DocsPage() {
  return <main className="docs-page">
    ...
    <section className="docs-hero"><div><p className="eyebrow">Technical documentation</p><h1>Publish knowledge<br />without the maze.</h1><p className="docs-lede">E is the compatibility layer between a knowledge publisher, the Hub registry, and E-compatible AI.</p></div><div className="docs-hero-index"><span>01</span><p>One public contract.<br />Two distribution paths.</p></div></section>
    <section className="docs-overview" aria-labelledby="docs-overview-title"><div className="docs-section-intro"><h2 id="docs-overview-title">Choose how knowledge travels.</h2><p>The content contract stays the same whether an E-compatible AI downloads a portable archive or retrieves from your hosted provider.</p></div><div className="docs-paths"><Link className="docs-path" href="/docs/remote-provider"><span className="docs-path-number">01</span><div><h3>Remote provider</h3><p>Keep your data where it is. Give the Hub a public provider URL and prove ownership once.</p><span className="docs-path-link">Read the provider guide ↗</span></div></Link><Link className="docs-path" href="/docs/local-archive"><span className="docs-path-number">02</span><div><h3>Local archive</h3><p>Package a validated E directory as a <code>.tar.gz</code> file. The Hub stores the immutable archive and its checksum.</p><span className="docs-path-link">Read the archive guide ↗</span></div></Link></div></section>
