...
const manifest = [
  "{", '  "id": "@acme/teyvat",', '  "name": "Teyvat Knowledge",', '  "publisher": "acme",', '  "version": "1.0.0",', '  "schemaVersion": "1.0",', '  "sources": [{ "id": "handbook", "title": "Official Handbook", "license": "CC-BY-4.0" }],', '  "capabilities": { "lexicalSearch": true, "semanticSearch": false, "structuredEntities": true, "relations": true, "revisions": true }', "}"
].join("\n");
const retrieve = [
