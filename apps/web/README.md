...
`DATABASE_URL` PostgreSQL connection string. `NEXT_PUBLIC_SUPABASE_URL` is only
the public Supabase Auth/API URL and must not be used as a database URL. Apply `db/migrations/003_publisher_control_plane.sql`
