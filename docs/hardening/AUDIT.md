...
| **AUD-10** | Fresh schema vs incremental migrations equivalence unverified. | **P2** | **RESOLVED (Phase 7)** | `differential/test/schema_lifecycle.test.ts` | Fresh install and migration replay verified with real PostgreSQL & SQLite instances. |
